...
function create_i18n() {
  ...
  I18n.translations = {
    en: {
      ...
      opening_days_text:
        "The city of Berlin allows for some exceptions. On these Sundays, many stores will be open for business.  Each opening day takes place during another city-wide event, listed below.",
    ...
    de: {
      ...
      opening_days_text:
        "Die Stadt Berlin erlaubt einige Ausnahmen. An diesen Sonntagen werden viele Geschäfte geöffnet sein. Jeder Verkaufsoffene Sonntag ist in Verbindung mit einer besondere Veranstaltung nachfolgend aufgeführt.",
